...
//
//case class McodState(var PD: mutable.HashMap[Int, Data], var MC: mutable.HashMap[Int, MicroCluster], var PDTree: MTree[Data])
//
//case class MicroCluster(var center: ListBuffer[Double], var points: ListBuffer[Data])
//
//class Pmcod_mtree_PD(time_slide: Int, range: Double, k_c: Int) extends ProcessWindowFunction[(Int, Data), (Long, Int), Int, TimeWindow] {
//
...
//      val current = McodState(PD, MC, PDTree)
